const continueRecovery = document.querySelector("#continueRecovery");
if (continueRecovery) {
  continueRecovery.addEventListener("click", () => {
    const url = `${window.location.origin}${window.location.pathname}#recovery-username`;
