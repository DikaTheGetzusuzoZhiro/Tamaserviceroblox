...
function openOrderTab() {
  const url = `${window.location.origin}${window.location.pathname}#recovery`;
...
function applyPageMode() {
  ...
  if (home) home.classList.toggle("hidden", isOrderPage);
  if (product) product.classList.toggle("hidden", isOrderPage);
  if (recovery) recovery.classList.toggle("hidden", !isOrderPage);
}
